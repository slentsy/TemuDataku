<x-app-layout>
    ...
    <div class="mt-10 mb-16">
        <div class="">
            ...
            <p class="mt-5 text-[22px]">
                Kamu akan mendapatkan sesi mentoring yang kamu mau dengan permasalahan yang kamu alami saat ini. Kamu dapat mengajukan mentoring untuk bidang Data Analyst, Data Scientist, dan Machine Learning Enginer.
            </p>
                ...
                <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    @foreach($katalog as $item)
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                            <img src="{{ asset('images/data-science.jpg' . $item->gambar) }}" alt="{{ $item->judul }}" class="w-full h-[240px] object-cover">
                            <div class="p-6">
